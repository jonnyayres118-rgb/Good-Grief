...
New visitors can explore and draft locally without an account. Email confirmation is required only to sync across devices, pay, download the PDF or share. Expired links now land on a branded recovery page where the customer can request a fresh email or continue drafting.
...
- Draft: pricing choices and a clear explanation that payment unlocks the designed PDF and trusted-person sharing.
...
- Only an active Annual or Lifetime member can create an invitation.
